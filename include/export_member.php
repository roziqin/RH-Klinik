...
<body>
	...
	<table border="1">
		...
		$sql ="SELECT * from transaksi, users, member WHERE transaksi_member=member_id and transaksi_user=id and transaksi_member=$member and $ket1 BETWEEN '$tgl11' AND '$tgl22' ORDER BY transaksi_id ASC";
