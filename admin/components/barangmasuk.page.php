	...
	<?php include 'modals/barangmasuk.modal.php'; ?>
...
<script type="text/javascript">
	$(document).ready(function(){
	    ...
	    $('.ordertype').on('click',function(){
            ...
            $.ajax({
				type:'POST',
		        url: "controllers/barangmasuk.ctrl.php?ket=ordertype",
                dataType: "json",
                data:{id:id},
                success:function(data){
		...
		$('#carimenu').bind("enterKey",function(e){
			var search = $(this).val();
			$('.container__load').load('components/content/barangmasuk.content.php?kond=search&q='+search);
			//alert(search);
			/*
			$.ajax({
                type: 'POST',
		...
		$('#batal').on('click',function(){
			$.ajax({
                type: 'POST',
		        url: "controllers/barangmasuk.ctrl.php?ket=batal",
                dataType: "json",
                success: function() {
