								...
								<div class="row pt-0 pb-2">
									<div class="col-md-6 btn-bottom">
										<div class="row">
											...
											<div class="col-md-6 p-0 hidden">
												<button type="button" class="btn btn-white waves-effect text-warning" id="tutupkasir"><i class="fas fa-cash-register m-0"></i>Tutup Kasir</button>
											</div>
	...
	<?php include 'modals/transaksigudangumum.modal.php'; ?>
...
<script type="text/javascript">
	$(document).ready(function(){
	    ...
	    $('.ordertype').on('click',function(){
            ...
            $.ajax({
				type:'POST',
		        url: "controllers/transaksigudangumum.ctrl.php?ket=ordertype",
                dataType: "json",
                data:{id:id},
                success:function(data){
		...
		$('#carimenu').bind("enterKey",function(e){
			var search = $(this).val();
			$('.container__load').load('components/content/transaksigudangumum.content.php?kond=search&q='+search);
			//alert(search);
			/*
			$.ajax({
                type: 'POST',
		...
		$('#batal').on('click',function(){
			$.ajax({
                type: 'POST',
		        url: "controllers/transaksigudangumum.ctrl.php?ket=batal",
                dataType: "json",
                success: function() {
