								...
								<div class="row pt-0 pb-2">
									<div class="col-md-6 btn-bottom">
										<div class="row">
											...
											-->
											<div class="col-md-6 p-0">
												<button type="button" class="btn btn-white waves-effect text-warning hidden" id="discount" data-toggle="modal" data-target="#modaldiscount"><i class="fas fa-tag m-0"></i>Discount</button>
											</div>
	...
	<?php include 'modals/transaksibarangmasuk.modal.php'; ?>
...
<script type="text/javascript">
	$(document).ready(function(){
	    ...
	    $('.ordertype').on('click',function(){
            ...
            $.ajax({
				type:'POST',
		        url: "controllers/transaksibarangmasuk.ctrl.php?ket=ordertype",
                dataType: "json",
                data:{id:id},
                success:function(data){
		...
		$('#carimenu').bind("enterKey",function(e){
			var search = $(this).val();
			$('.container__load').load('components/content/transaksibarangmasuk.content.php?kond=search&q='+search);
			//alert(search);
			/*
			$.ajax({
                type: 'POST',
                url: "components/content/transaksibarangmasuk.content.php?kond=search",
                dataType: "json",
                data:{search:search},
                success: function(data) {
                	console.log(data)
		...
		$('#batal').on('click',function(){
			$.ajax({
                type: 'POST',
		        url: "controllers/transaksibarangmasuk.ctrl.php?ket=batal",
                dataType: "json",
                success: function() {
