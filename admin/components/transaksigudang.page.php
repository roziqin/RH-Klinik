				...
				<div class="row">
					...
					<div class="col-md-4 position-relative box-right">
						<div class="row">
							...
							<div class="col-md-12 text-white mt-0 fadeIn animated info-color-dark pt-3 pb-1 hidden" id="listmember">
							...
							<div class="col-md-12 box-bottom info-color-dark pt-2">
								...
								?>
								<div class="row text-white border-top pt-1 hidden">
								...
								<div class="row pt-0 pb-2">
									...
									<div class="col-md-6 btn-bottom pr-1">
										<button type="button" class="btn btn-white waves-effect text-info" id="bayar" data-toggle="modal" data-target="#modaltransaksi"><i class="fas fa-money-bill m-0"></i>Proses</button>
									</div>
								</div>
	...
	<?php include 'modals/transaksigudang.modal.php'; ?>
...
*/
	    $('.ordertype').on('click',function(){
            ...
            $.ajax({
				type:'POST',
		        url: "controllers/transaksigudang.ctrl.php?ket=ordertype",
                dataType: "json",
                data:{id:id},
                success:function(data){
		...
		$('#carimenu').bind("enterKey",function(e){
			var search = $(this).val();
			$('.container__load').load('components/content/transaksigudang.content.php?kond=search&q='+search);
			//alert(search);
			/*
			$.ajax({
                type: 'POST',
		...
		$('#batal').on('click',function(){
			$.ajax({
                type: 'POST',
		        url: "controllers/transaksigudang.ctrl.php?ket=batal",
                dataType: "json",
                success: function() {
		    ...
		    $.ajax({
		        ...
		        success:function(data){
		        	for (var i in data) {
		        			...
		        			$('#listbarang tbody').append("<tr><td>"+data[i].barang_id+"</td><td>"+data[i].barang_nama+"</td><td class='text-right'>"+data[i].transaksi_gudang_detail_temp_jumlah+"</td></tr>");
