    ...
    if ($d==null) { ?>
        <div class="row p-3 row-jumlah justify-content-md-center">
            <div class="col-md-6 mt-5">
                ...
                <form method="post" class="form-member">
                    <input type="hidden" id="defaultForm-therapist" name="ip-therapist">
...
<?php } elseif ($kond=='kembalian') { ?>
    ...
    <script type="text/javascript">
        ...
        windowList = new Array('../print/nota-apotek.print.php?id='+nota);
        i = 0;
        windowName = "window";
...
<script type="text/javascript">
    $('.pilihmember').on('click',function(e){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $('.container__load').load('components/content/apotek.content.php?kond=transaksi');
            }
        }); 
    });
    $('.daftar').on('click',function(e){
        ...
        $.ajax({
            ...
            success:function(data){
                console.log(data);
                window.location.reload();
                $('.container__load').load('components/content/apotek.content.php?kond=home');
            }
        }); 
    });
          ...
          "drawCallback": function( settings, json ) {
                $('.pilihmenu').on('click',function(e){
                    if(e.handled !== true) {
                        ...
                        console.log("b")
                        $('.container__load').load('components/content/apotek.content.php?kond=jumlah&id='+barang_id);
                        e.handled = true;
                    }
                }); 
                        ...
                        $.ajax({
                            ...
                            success:function(data){
                                ...
                                if (data.totalordertemp.toString()=="Stok Kurang") {
                                    ...
                                    $('.container__load').load('components/content/apotek.content.php?kond=');
    ...
    $('.pilihjenis').on('click',function(){
        ...
        $('.container__load').load('components/content/apotek.content.php?kond=item&jenisid='+jenis_id);
    });
    ...
    $('#ceknota').on('click',function(){
        $('.container__load').load('components/content/apotek.content.php?kond=ceknota&nonota=');
    });
    ...
    $('#tutupkasir').on('click',function(){
        $('.container__load').load('components/content/apotek.content.php?kond=tutupkasir&omset=');
    });
...
<?php } elseif ($kond=='ceknota' || $kond=='tutupkasir') { ?>
    <script type="text/javascript">
        ...
        $('.prosesceknota').on('click',function(e){
            e.preventDefault();
            var idnonota = $('#idnonota').val();
            $('.container__load').load('components/content/apotek.content.php?kond=ceknota&nonota='+idnonota);
        });
        ...
        $('#btn-printulang').on('click',function(e){
            ...
            windowList = new Array('../print/nota-apotek.print.php?id='+idnonota);
            i = 0;
            windowName = "window";
            windowInterval = window.setInterval(function(){
              window.open(windowList[i],windowName+i,'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=0,titlebar=no');
