<?php include '../modals/produk.modal.php'; ?>
    ...
    <button class="btn btn-primary btn-tambah-produk-apotek" data-toggle="modal" data-target="#modalproduk">Tambah Produk <i class="fas fa-box-open ml-1"></i></button>
    ...
    $(document).ready(function() {
        ...
        $('.btn-tambah-produk-apotek').on('click',function(){
        ...
        $('#example').DataTable( {
            ...
            "ajax": 
            {
                "url": "api/datatable.api.php?ket=produkapotek", // URL file untuk proses select datanya
                "type": "POST"
            },
            "deferRender": true,
            "columns": [
