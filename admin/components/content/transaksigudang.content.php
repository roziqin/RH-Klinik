    ...
    <div class="classic-tabs">
        ...
        <ul class="nav tabs-white border-bottom" id="myClassicTab" role="tablist">
            ...
            <?php
                ...
                $sql="SELECT * from jenis ORDER BY jenis_nama";
...
<script type="text/javascript">
    ...
    $('.pilihmember').on('click',function(e){
        ...
        $.ajax({
            ...
            url: "controllers/transaksigudang.ctrl.php?ket=pilihmember",
          ...
          "drawCallback": function( settings, json ) {
                ...
                $('.pilihmenu').on('click',function(e){
                    ...
                    if(e.handled !== true) {
                        ...
                        $('.container__load').load('components/content/transaksigudang.content.php?kond=jumlah&id='+barang_id);
                ...
                $('.tambahmenu').on('click',function(e){
                    ...
                    if(e.handled !== true) {
                        ...
                        $.ajax({
                            ...
                            url: "controllers/transaksigudang.ctrl.php?ket=tambahmenu",
                            ...
                            success:function(data){
                                ...
                                if (data.totalordertemp.toString()=="Stok Kurang") {
                                    ...
                                    $('.container__load').load('components/content/transaksigudang.content.php?kond=');
    ...
    $('.pilihjenis').on('click',function(){
        ...
        $('.container__load').load('components/content/transaksigudang.content.php?kond=item&jenisid='+jenis_id);
    ...
    $('#ceknota').on('click',function(){
        ...
        $('.container__load').load('components/content/transaksigudang.content.php?kond=ceknota&nonota=');
    ...
    $('#tutupkasir').on('click',function(){
        ...
        $('.container__load').load('components/content/transaksigudang.content.php?kond=tutupkasir&omset=');
...
<?php } elseif ($kond=='ceknota' || $kond=='tutupkasir') { ?>
    ...
    <script type="text/javascript">
        ...
        $('.prosesceknota').on('click',function(e){
            ...
            $('.container__load').load('components/content/transaksigudang.content.php?kond=ceknota&nonota='+idnonota);
        ...
        $('.prosestutupkasir').on('click',function(e){
            ...
            $.ajax({
                ...
                url: "controllers/transaksigudang.ctrl.php?ket=tutupkasir",
...
<script type="text/javascript">
	...
	function removeItemTemp(id, index, classdiskon) {
		...
		$.ajax({
	        ...
	        url: "controllers/transaksigudang.ctrl.php?ket=removeitem",
	...
	function plusminusItem(id, idbarang, index, keterangan, jumlah) {
		...
		$.ajax({
	        ...
	        url: "controllers/transaksigudang.ctrl.php?ket=plusminus",
