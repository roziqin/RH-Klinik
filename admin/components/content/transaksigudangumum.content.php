...
$con = mysqli_connect("localhost","u6461685_user","bismillah321","u6461685_skincare");
                ...
                <form method="post" class="form-member">
                        ...
                        <select class="mdb-select md-form" id="defaultForm-member" name="ip-member" searchable="Search here..">
                            ...
                            <?php
                                ...
                                while ($data1=mysqli_fetch_array($result,MYSQLI_ASSOC)) {
                                    echo "<option value='$data1[member_id]'>$data1[member_nama] - $data1[member_hp]</option>";
                                }
                            ?>
                        </select>
                    </div>
                    <div class="md-form mb-5 hidden">
                        <select class="mdb-select md-form" id="defaultForm-cs" name="ip-cs" searchable="Search here..">
                            ...
                            <?php
                                $sql="SELECT * from users, roles where role=roles_id and roles_name='cs' ORDER BY id ASC";
                                $result=mysqli_query($con,$sql);
                                while ($data1=mysqli_fetch_array($result,MYSQLI_ASSOC)) {
                    ...
                    <div class="md-form mb-5">
                        <select class="mdb-select md-form" id="defaultForm-kasir" name="ip-kasir" searchable="Search here..">
                            <option value="" disabled selected>Pilih Kasir</option>
                            <?php
                                $sql="SELECT * from users, roles where role=roles_id and roles_name='kasir' ORDER BY id ASC";
                                $result=mysqli_query($con,$sql);
                                while ($data1=mysqli_fetch_array($result,MYSQLI_ASSOC)) {
                                    echo "<option value='$data1[id]'>$data1[name]</option>";
                                }
                    ...
                    <div class="md-form mb-3">
                        <input type="text" id="defaultForm-tlp" class="form-control" name="ip-tlp">
                        <label for="defaultForm-tlp">No. Tlp</label>
                    </div>
                    <button class="btn btn-primary tambahmember float-right">Tambah Member</button>
                            ...
                            <table id="example-<?php echo $data1['jenis_id']; ?>" class="table table-striped table-bordered fadeIn animated" style="width:100%">
                                ...
                                <?php
                                    ...
                                    while ($databarang=mysqli_fetch_array($querybarang, MYSQLI_ASSOC)) {
                                        ...
                                        if ($databarang['barang_stok_gudang']!=0) {
                                            $stok_status="";
                                            /*
                                            ...
                                            */
                                            ...
                                            ?>
                                            <tr>
                                                <td><strong class=""><?php echo $databarang['barang_kode']; ?></strong></td>
                                            ...
                                            <tr>
                                                <td><strong class=""><?php echo $databarang['barang_kode']; ?></strong></td>
                                                <td><strong class=""><?php echo $databarang['barang_nama']; ?></strong></td>
                                                <td><strong class=""><?php echo $databarang['brand_nama']; ?></strong></td>
                                                <td><strong class=""><?php echo $databarang['kategori_nama']; ?></strong></td>
                                                <td><strong class=""><?php echo $databarang['ukuran_nama']; ?></strong></td>
                                                <td><strong class=""><?php echo $databarang['varian_nama']; ?></strong></td>
                                                <td><strong class=""><?php echo $databarang['warna_nama']; ?></strong></td>
                                                <td><span class="stok <?php echo $stok_status; ?>"><?php echo $databarang['barang_stok_gudang']; ?></span></td>
                                                <td></td>
                                            </tr>
                                            <?php*/
...
<?php } elseif ($kond=='kembalian') { ?>
    ...
    <script type="text/javascript">
        ...
        windowList = new Array('../print/notagudang.print.php?id='+nota);
...
<?php }  elseif ($kond=='ceknota') { ?>
    ...
    <div class="row p-3 row-jumlah justify-content-md-center">
        ...
        <?php if ($_GET['nonota']!='') { 
            ...
            $sqlnot="SELECT * FROM transaksi_gudang, member where transaksi_gudang_member=member_id AND transaksi_gudang_id='$nota' ";

            $querynot=mysqli_query($con,$sqlnot);

            $datanot=mysqli_fetch_assoc($querynot);

            $diskon = $datanot['transaksi_gudang_diskon'];

            $total = $datanot['transaksi_gudang_total'];
            ...
            <div class="row">
                ...
                <table id="listbarang" class="table table-bordered table-striped">
                    ...
                    <?php
                        ...
                        $sqlte1="SELECT * from transaksi_gudang_detail, barang where transaksi_gudang_detail_barang_id=barang_id and transaksi_gudang_detail_nota='$nota' ORDER BY transaksi_gudang_detail_id ASC";

                        $queryte1 = mysqli_query($con,$sqlte1);

                        while($datatea = mysqli_fetch_assoc($queryte1)) {

                            $jumlah = $datatea["transaksi_gudang_detail_jumlah"];
                        ...
                        <?php
                            ...
                            if ($datatea["transaksi_gudang_detail_diskon"]!=0) {
                            ...
                            ?>
                                ...
                                <tr style="font-weight: 700;">
                                    ...
                                    <td class="text-right">Rp. <?php echo format_rupiah($datatea["transaksi_gudang_detail_diskon"]); ?></td>
...
<script type="text/javascript">
    ...
    $('.pilihmember').on('click',function(e){
        ...
        var idtherapist = '';
        var cs = $('#defaultForm-cs').val();
        var kasir = $('#defaultForm-kasir').val();

        $.ajax({
            type:'POST',
            url: "controllers/transaksigudangumum.ctrl.php?ket=pilihmember",
            dataType: "json",
            data:{
                idmember:idmember,
            ...
            success:function(data){
                ...
                $('.container__load').load('components/content/transaksigudangumum.content.php?kond=home');
            }
        }); 
    });

    $('.tambahmember').on('click',function(e){
        e.preventDefault();
        var nama = $('#defaultForm-nama').val();
        var tlp = $('#defaultForm-tlp').val();

        if (nama!='') {
            $.ajax({
                type:'POST',
                url: "controllers/transaksigudangumum.ctrl.php?ket=tambahmember",
                dataType: "json",
                data:{
                    nama:nama,
                    tlp:tlp
                ...
                success:function(data){
                    if (data.ket == "gagal") {
                        $.confirm({
                              ...
                              content: 'Data member sudah terdaftar',
                              buttons: {
                                  confirm: {
                                      text: 'Close',
          ...
          "drawCallback": function( settings, json ) {
                ...
                $('.pilihmenu').on('click',function(e){
                    ...
                    if(e.handled !== true) {
                        ...
                        $('.container__load').load('components/content/transaksigudangumum.content.php?kond=jumlah&id='+barang_id);
                ...
                $('.tambahmenu').on('click',function(e){
                    if(e.handled !== true) {
                        ...
                        $.ajax({
                            type:'POST',
                            url: "controllers/transaksigudangumum.ctrl.php?ket=tambahmenu",
                            dataType: "json",
                            data:{
                                barang_id:barang_id,
                                jumlah:jumlah,
                            ...
                            success:function(data){
                                ...
                                if (data.totalordertemp.toString()=="Stok Kurang") {
                                    ...
                                    if (data.item.transaksi_gudang_detail_temp_diskon!=0) {

                                        diskon = '<tr class="fadeInLeft animated diskon"><td></td><td>Diskon</td><td></td><td><span class="text_total">Rp. '+formatRupiah((data.item.transaksi_gudang_detail_temp_jumlah*data.item.transaksi_gudang_detail_temp_diskon).toString())+'</span></td></tr>';
                                    ...
                                    var content = '<tr class="'+ketdiskon+' fadeInLeft animated"><td><button type="button" class="btn btn-dark-info waves-effect btn orange-text m-0 p-0 btn-remove" data-id="'+data.item.transaksi_gudang_detail_temp_id+'"><i class="fas fa-times"></i></button></td><td>'+data.item.barang_nama+'<br><span>'+data.item.transaksi_gudang_detail_temp_keterangan+'</span></td><td><button type="button" class="btn btn-dark-info waves-effect btn btn-outline-white mr-2 mt-0 ml-0 mb-0 p-1 btn-plusminus" data-ket="minus" data-id="'+data.item.transaksi_gudang_detail_temp_id+'" data-idbarang="'+data.item.transaksi_gudang_detail_temp_barang_id+'" data-jumlah="'+data.item.transaksi_gudang_detail_temp_jumlah+'"><i class="fas fa-minus"></i></button><span class="text_jumlah">'+data.item.transaksi_gudang_detail_temp_jumlah+'</span><button type="button" class="btn btn-dark-info waves-effect btn-outline-white mr-0 mt-0 ml-2 mb-0 p-1 btn-plusminus" data-ket="plus" data-id="'+data.item.transaksi_gudang_detail_temp_id+'" data-idbarang="'+data.item.transaksi_gudang_detail_temp_barang_id+'" data-jumlah="'+data.item.transaksi_gudang_detail_temp_jumlah+'"><i class="fas fa-plus"></i></button></td><td><span class="text_total">'+formatRupiah(data.item.transaksi_gudang_detail_temp_total, 'Rp. ')+'</span></td></tr>'+diskon;
                                    ...
                                    $('.container__load').load('components/content/transaksigudangumum.content.php?kond=');
    ...
    $('.pilihjenis').on('click',function(){
        ...
        $('.container__load').load('components/content/transaksigudangumum.content.php?kond=item&jenisid='+jenis_id);
    ...
    $('#ceknota').on('click',function(){
        ...
        $('.container__load').load('components/content/transaksigudangumum.content.php?kond=ceknota&nonota=');
    ...
    $('#tutupkasir').on('click',function(){
        ...
        $('.container__load').load('components/content/transaksigudangumum.content.php?kond=tutupkasir&omset=');
...
<?php } elseif ($kond=='ceknota' || $kond=='tutupkasir') { ?>
    ...
    <script type="text/javascript">
        ...
        $('.prosesceknota').on('click',function(e){
            ...
            $('.container__load').load('components/content/transaksigudangumum.content.php?kond=ceknota&nonota='+idnonota);
        ...
        $('.prosestutupkasir').on('click',function(e){
            ...
            $.ajax({
                ...
                url: "controllers/transaksigudangumum.ctrl.php?ket=tutupkasir",
                ...
                success:function(data){
                    ...
                    if (data.ket == "gagal") {
                        ...
                        if (selisih < 0) {
                            ...
                            windowList = new Array('../print/omsetgudang.print.php');
        ...
        $('#btn-printulang').on('click',function(e){
            ...
            windowList = new Array('../print/notagudang.print.php?id='+idnonota);
...
if ($kond=='home') { ?>
    ...
    <script type="text/javascript">
		...
		$.ajax({
	        ...
	        url:'api/view.api.php?func=list-transaksi-temp-gudang',
	        ...
	        success:function(data){
				...
				for (var i in data) {
                    ...
                    if (data[i].transaksi_gudang_detail_temp_diskon!=0) {

                        diskon = '<tr class="diskon"><td></td><td>Diskon</td><td></td><td><span class="text_total">Rp. '+formatRupiah((data[i].transaksi_gudang_detail_temp_jumlah*data[i].transaksi_gudang_detail_temp_diskon).toString())+'</span></td></tr>';
				    ...
				    content += '<tr class="'+ketdiskon+'"><td><button type="button" class="btn btn-dark-info waves-effect btn orange-text m-0 p-0 btn-remove" data-id="'+data[i].transaksi_gudang_detail_temp_id+'"><i class="fas fa-times"></i></button></td><td>'+data[i].barang_nama+'<br><span>'+data[i].transaksi_gudang_detail_temp_keterangan+'</span></td><td><button type="button" class="btn btn-dark-info waves-effect btn btn-outline-white mr-2 mt-0 ml-0 mb-0 p-1 btn-plusminus"  data-ket="minus" data-id="'+data[i].transaksi_gudang_detail_temp_id+'" data-idbarang="'+data[i].transaksi_gudang_detail_temp_barang_id+'" data-jumlah="'+data[i].transaksi_gudang_detail_temp_jumlah+'"><i class="fas fa-minus"></i></button><span class="text_jumlah">'+data[i].transaksi_gudang_detail_temp_jumlah+'</span><button type="button" class="btn btn-dark-info waves-effect btn-outline-white mr-0 mt-0 ml-2 mb-0 p-1 btn-plusminus" data-ket="plus" data-id="'+data[i].transaksi_gudang_detail_temp_id+'" data-idbarang="'+data[i].transaksi_gudang_detail_temp_barang_id+'" data-jumlah="'+data[i].transaksi_gudang_detail_temp_jumlah+'"><i class="fas fa-plus"></i></button></td><td><span class="text_total">'+formatRupiah(data[i].transaksi_gudang_detail_temp_total, 'Rp. ')+'</span></td></tr>'+diskon;

				    subtotal += parseInt(data[i].transaksi_gudang_detail_temp_total);
            ...
            success:function(data){
                ...
                if (data!='') {
                    ...
                    $('#listmember table').append('<tr><td><h6>Nama Member: '+nama+'</h6></td><td class="text-right"><h6>Alamat Member: '+data[0].member_alamat+'</h6></td></tr>'+
                        '<tr><td><h6>Nama Kasir: '+data[0].name+'</h6></td><td class="text-right"></td></tr>');
...
<script type="text/javascript">
	...
	function removeItemTemp(id, index, classdiskon) {
		...
		$.ajax({
	        ...
	        url: "controllers/transaksigudangumum.ctrl.php?ket=removeitem",
	...
	function plusminusItem(id, idbarang, index, keterangan, jumlah) {
		...
		$.ajax({
	        ...
	        url: "controllers/transaksigudangumum.ctrl.php?ket=plusminus",
