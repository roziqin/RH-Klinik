                        ...
                        <div class="row">
                            ...
                            <table id="example-<?php echo $data1['jenis_id']; ?>" class="table table-striped table-bordered fadeIn animated" style="width:100%">
                                ...
                                <?php
                                    ...
                                    $sqlbarang="SELECT * from barang, brand, jenis, kategori, warna, varian, ukuran where barang_kategori=kategori_id and barang_jenis=jenis_id and barang_brand=brand_id and barang_varian=varian_id and barang_warna=warna_id and barang_ukuran=ukuran_id and jenis_id='$data1[jenis_id]'";
...
<script type="text/javascript">
    ...
    $('.pilihmember').on('click',function(e){
        ...
        $.ajax({
            ...
            url: "controllers/barangmasuk.ctrl.php?ket=pilihmember",
            ...
            success:function(data){
                ...
                $('.container__load').load('components/content/barangmasuk.content.php?kond=home');
          ...
          "drawCallback": function( settings, json ) {
                ...
                $('.pilihmenu').on('click',function(e){
                    ...
                    if(e.handled !== true) {
                        ...
                        $('.container__load').load('components/content/barangmasuk.content.php?kond=jumlah&id='+barang_id);
                ...
                $('.tambahmenu').on('click',function(e){
                    ...
                    if(e.handled !== true) {
                        ...
                        $.ajax({
                            ...
                            url: "controllers/barangmasuk.ctrl.php?ket=tambahmenu",
                            ...
                            success:function(data){
                                ...
                                if (data.totalordertemp.toString()=="Stok Kurang") {
                                    ...
                                    $('.container__load').load('components/content/barangmasuk.content.php?kond=');
    ...
    $('.pilihjenis').on('click',function(){
        ...
        $('.container__load').load('components/content/barangmasuk.content.php?kond=item&jenisid='+jenis_id);
    ...
    $('#ceknota').on('click',function(){
        ...
        $('.container__load').load('components/content/barangmasuk.content.php?kond=ceknota&nonota=');
    ...
    $('#tutupkasir').on('click',function(){
        ...
        $('.container__load').load('components/content/barangmasuk.content.php?kond=tutupkasir&omset=');
...
<?php } elseif ($kond=='ceknota' || $kond=='tutupkasir') { ?>
    ...
    <script type="text/javascript">
        ...
        $('.prosesceknota').on('click',function(e){
            ...
            $('.container__load').load('components/content/barangmasuk.content.php?kond=ceknota&nonota='+idnonota);
        ...
        $('.prosestutupkasir').on('click',function(e){
            ...
            $.ajax({
                ...
                url: "controllers/barangmasuk.ctrl.php?ket=tutupkasir",
...
<script type="text/javascript">
	...
	function removeItemTemp(id, index, classdiskon) {
		...
		$.ajax({
	        ...
	        url: "controllers/barangmasuk.ctrl.php?ket=removeitem",
	...
	function plusminusItem(id, idbarang, index, keterangan, jumlah) {
		...
		$.ajax({
	        ...
	        url: "controllers/barangmasuk.ctrl.php?ket=plusminus",
