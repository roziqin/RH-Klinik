    ...
    <div class="modal-content">
      ...
      <div class="modal-body mx-3">
        ...
        <div class="md-form mb-0 hidden">
          <input type="text" id="defaultForm-nama" class="form-control validate mb-1" name="ip-nama">
  ...
  <script type="text/javascript">
      ...
      $("#submit-transaksi").click(function(e){
        ...
        if (bayar < total) {
          ...
          $.ajax({
            type: 'POST',
            url: "controllers/transaksigudangumum.ctrl.php?ket=prosestransaksi",
            data: data,
            cache: false,
            processData: false,
            contentType: false,
            success: function(data) {
              ...
              $('.container__load').load('components/content/transaksigudangumum.content.php?kond=kembalian');
