...
<div class="modal fade" id="modaltransaksi" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body mx-3 transaksi">
  ...
  <script type="text/javascript">
      ...
      $("#submit-transaksi").click(function(e){
        ...
        if (bayar < total) {
          ...
          $.ajax({
            type: 'POST',
            url: "controllers/transaksibarangmasuk.ctrl.php?ket=prosestransaksi",
            data: data,
            cache: false,
            processData: false,
            contentType: false,
            success: function(data) {
              ...
              $('.container__load').load('components/content/transaksibarangmasuk.content.php?kond=kembalian');
