					...
					<div class="col-md-4 position-relative box-right">
							...
							<div class="row">
								...
								<div class="col-md-12 box-bottom info-color-dark pt-2">
								    ...
								    <input type="hidden" id="defaultForm-status" name="ip-status" value="1">
									...
									<div class="row pt-0 pb-2">
										...
										<!--<div class="col-md-6 btn-bottom pr-1">
											<button type="button" class="btn btn-white waves-effect text-info" id="bayar"><i class="fas fa-money-bill m-0"></i>Proses</button>
										</div>-->
									</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#carimenu').bind("enterKey",function(e){
			var search = $(this).val();
			$('.container__load').load('components/content/apotek.content.php?kond=search&q='+search);
			//alert(search);
			/*
			$.ajax({
                type: 'POST',
                url: "components/content/apotek.content.php?kond=search",
                dataType: "json",
                data:{search:search},
                success: function(data) {
                	console.log(data)
